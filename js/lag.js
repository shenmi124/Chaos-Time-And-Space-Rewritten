addLayer("Language", {
    ...
    tabFormat: [
        "blank",
        ["display-text", function() { return "<h3>本游戏基于The Modding <b>Table</b>制作<br>This game based on The Modding <b>Table</b><br><br>选择语言(英文版可能会有一些bug)<br>Choose your language(there may be some bugs in English mode)<br><br>你可以在设置中改变语言<br>You can change the language in the settings.</h3>" }],
        "blank", 
        "blank",
        'clickables',
        "blank",
